...
def check_timeout_sync():
    ...
    # Leer settings.json
    try:
        with open('/home/user/.claude/settings.json', 'r') as f:
...
def check_server_code():
    ...
    server_file = '/home/user/IA/ccglm-mcp/ccglm_mcp_server.py'
...
def check_hashtag_registry():
    ...
    try:
        with open('/home/user/.claude/agents/hashtag-registry.json', 'r') as f:
...
def check_test_script():
    ...
    script_path = '/home/user/IA/ccglm-mcp/test_ccglm_performance.sh'

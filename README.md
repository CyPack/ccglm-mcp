...
GLM_AUTH_TOKEN=your_z_ai_token_here
```
...
```json
{
  "mcpServers": {
    "ccglm-mcp": {
      "command": "python3",
      "args": ["/home/user/IA/ccglm-mcp/ccglm_mcp_server.py"],
      "timeout": 300000
    }
  }
}
...
export GLM_API_TOKEN="your_z_ai_token_here"
...
```bash
python3 /home/user/IA/ccglm-mcp/ccglm_mcp_server.py 2>&1 | grep -i glm
```

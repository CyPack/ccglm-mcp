...
async def list_tools() -> List[types.Tool]:
    ...
    return [
        types.Tool(
            name="ccglm",
            description="Route prompt to GLM-4.7 (default) or glm-4.5-air (fast) via Claude CLI with Z.AI credentials",
            inputSchema={
                "type": "object",
                "properties": {
                    "prompt": {
                    ...
                    "model": {
                        "type": "string",
                        "description": "GLM model to use (glm-4.7 or glm-4.5-air)",
                        "default": "glm-4.7",
...
async def ccglm_route(args: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        model_timeout = 120 if model == "glm-4.5-air" else DEFAULT_TIMEOUT  # glm-4.7 uses default
